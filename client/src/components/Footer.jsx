...
export default function Footer() {
  return (
    <footer className="text-center py-20 border-t border-gray-200">
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        Cloud Storage That Just Works
      </h2>
      <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-6">
        Meet <strong>Storio</strong> — a smarter way to store, access, and share
        your files online. Simple pricing. Serious security.
      </p>
      <Link
        to="/signup"
